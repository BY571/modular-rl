...
from src.vecenvs import SubprocVecEnv 
...
def train(args):
    ...
    with wandb.init(project="Modular-RL", name=args.run_name, config=args):
        s = time.time()
        ...
        while total_timesteps < args.max_timesteps:
            ...
            for i in range(num_envs_train):
                ...
                wandb.log({'{}_instant_reward'.format(envs_train_names[i]): reward_list[i]}, step=total_timesteps)
